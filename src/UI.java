...
public class UI {
    ...
    public JButton addGameButton(String buttonText, int x, int y, int weightx, int weighty, JFrame frame) { // create and define add button
        ...
        addGameButton_gbc.anchor = GridBagConstraints.CENTER; // Anchor position
    ...
    public JList gameList(DefaultListModel list, JFrame frame) {
        ...
        //  define constraints
        list_gbc.gridx = 1; // Column
        list_gbc.gridy = 1; // Row
